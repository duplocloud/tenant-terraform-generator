...
func (c *Client) DuploK8sSecretProviderClassList(tenantID string) (*[]DuploK8sSecretProviderClass, ClientError) {
	rp := []DuploK8sSecretProviderClass{}
	err := c.getAPI(
		fmt.Sprintf("DuploK8sSecretProviderClassGet(%s)", tenantID),
